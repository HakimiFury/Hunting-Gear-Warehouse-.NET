Module mod_globals_a208749

    Public username As String

    Public myconnection As String = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=DB_huntinggearwarehouse_a208749.accdb;Persist Security Info=False;"
